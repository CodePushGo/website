    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="space-y-4 sm:space-y-8">
          <div class="overflow-hidden bg-white shadow-md rounded-xl">
            <div class="p-9">
              ...
              <p class="mt-6 text-base text-gray-400 font-pj">
      ...
      <div class="max-w-4xl mx-auto mt-12 text-center">
        ...
        <a
          ...
          class="inline-flex items-center justify-center px-6 py-3 mt-8 text-lg font-medium text-white bg-[#8d2045] rounded-md hover:bg-[#4f1226] focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
        >
          {{ m.setup_ci_cd_now() }}
        </a>
      </div>
