...
<template>
  <section class="py-10 bg-[#8d2045] sm:py-16 lg:py-24">
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 mt-12 gap-x-20 gap-y-16 md:mt-20 md:grid-cols-2">
        <div class="flex items-start">
          <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 bg-[#631731] rounded-full">
      ...
      <div class="flex items-center justify-center mt-12 md:mt-20">
        <div class="px-8 py-4 text-center bg-[#4f1226] rounded-full">
