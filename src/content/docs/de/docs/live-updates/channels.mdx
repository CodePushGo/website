...
1. Gehen Sie zum Bereich "Channels" im CodePushGo Dashboard
...
Um ein Live-Update bereitzustellen, müssen Sie einen neuen JS-Bundle-Build hochladen und einem Kanal zuweisen. Sie können dies in einem Schritt mit der CodePushGo CLI tun:
...
Sie können Builds auch über den "Bundles"-Bereich des CodePushGo Dashboards Kanälen zuweisen. Klicken Sie auf das Menü-Symbol neben einem Build und wählen Sie "Assign to Channel", um den Kanal für diesen Build auszuwählen.

## Bundle-Versionierung und Kanäle

Es ist wichtig zu beachten, dass Bundles in CodePushGo global für Ihre App sind und nicht spezifisch für einzelne Kanäle. Dasselbe Bundle kann mehreren Kanälen zugewiesen werden.
...
Für fortgeschrittenere Workflows können Sie Ihre Live-Update-Deployments als Teil Ihrer CI/CD-Pipeline automatisieren. Durch die Integration von CodePushGo in Ihren Build-Prozess können Sie automatisch neue Bundles hochladen und Kanälen zuweisen, wenn Sie zu bestimmten Branches pushen oder neue Releases erstellen.

Schauen Sie sich die [CI/CD Integration](/docs/getting-started/cicd-integration/) Dokumentation an, um mehr über die Automatisierung von CodePushGo Live-Updates zu erfahren.
...
1. Installieren Sie das CodePushGo SDK in Ihrer App
