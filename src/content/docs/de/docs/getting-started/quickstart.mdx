...
Das Quickstart-Tutorial führt Sie durch die wichtigsten Konzepte von CodePushGo! Zu den behandelten Konzepten gehören:

<Steps>

1. Hinzufügen einer App zu Ihrem CodePushGo-Konto

2. Integration von CodePushGo in Ihre CI/CD

3. Auslösen des Bundle-Uploads auf CodePushGo durch Pushen von Commits

4. Konfiguration und Anpassung der CodePushGo Bundle-Veröffentlichung

5. Einrichten Ihrer App für Live-Updates über CodePushGo

6. Bereitstellung von Live-Updates für Ihre App von CodePushGo aus
...
<CardGrid stagger>
  <a href="/docs/getting-started/add-an-app/" ><Card title="Tutorial starten" icon="rocket" >
    Folgen Sie dem Quickstart-Tutorial und nutzen Sie CodePushGo in kürzester Zeit!
  </Card></a>
  <a href="/docs/getting-started/deploy/"><Card title="Einfach zu integrieren" icon="pencil">
    Integrieren Sie CodePushGo in Ihre CI/CD und lösen Sie Bundle-Uploads auf CodePushGo durch Pushen von Commits aus
  </Card></a>
...
<LinkCard
	title="Probieren Sie GPTS CodePushGo aus, um Hilfe zu erhalten, anstatt die Dokumentation zu lesen"
...
Um dies zu ermöglichen, müssen wir alle unseren Teil beitragen, auch Sie 🥹 Wenn CodePushGo Cloud Ihre Bedürfnisse nicht erfüllt, können Sie einen bootstrapped Maker [hier](https://github.com/sponsors/riderx/) zu Ihren eigenen Bedingungen unterstützen
