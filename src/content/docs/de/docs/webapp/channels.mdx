...
Anders ausgedrückt: Wenn Sie einen neuen Benutzer haben, wird CodePushGo versuchen, ihm die neueste Version dieses Standardkanals zu liefern.
...
Siebens ist `Emulatoren erlauben`. Wenn dies falsch ist, wird CodePushGo jede Update-Anfrage ablehnen, die von einem Emulator kommt. Dies ist hauptsächlich für Testzwecke nützlich.
