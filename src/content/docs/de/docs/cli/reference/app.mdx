...
Der `app`-Befehl ermöglicht die Verwaltung Ihrer CodePushGo-Apps

### add

`npx @capgo/cli app add [appId]`

Fügt eine neue App zu Ihrem CodePushGo-Konto hinzu
...
- `--icon [path]`: Pfad zu einem benutzerdefinierten Symbol, das in der CodePushGo-Webanwendung angezeigt wird
...
Aktualisiert eine bestehende App in Ihrem CodePushGo-Konto
...
Listet alle Apps in Ihrem CodePushGo-Konto auf
...
Löscht eine App aus Ihrem CodePushGo-Konto
