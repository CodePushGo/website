...
El tutorial de inicio rápido te guiará a través de los conceptos clave de CodePushGo. Los conceptos que se explorarán incluyen:

<Steps>

1. Agregar una aplicación a tu cuenta de CodePushGo

2. Integrar CodePushGo con tu CI/CD

3. Activar la carga de paquetes en CodePushGo al enviar commits

4. Configurar y personalizar la publicación de paquetes de CodePushGo

5. Configurar tu aplicación para habilitar actualizaciones en vivo a través de CodePushGo

6. Implementar actualizaciones en vivo en tu aplicación desde CodePushGo
...
<CardGrid stagger>
  <a href="/docs/getting-started/add-an-app/" ><Card title="Comenzar el Tutorial" icon="rocket" >
    ¡Sigue el tutorial de inicio rápido y comienza a usar CodePushGo en poco tiempo!
  </Card></a>
  <a href="/docs/getting-started/deploy/"><Card title="Fácil de integrar" icon="pencil">
    Integra CodePushGo con tu CI/CD y activa cargas de paquetes en CodePushGo al enviar commits
  </Card></a>
...
<LinkCard
	title="Prueba GPTS CodePushGo para obtener ayuda en lugar de leer la documentación"
...
Para hacer esto posible, es necesario que todos hagamos nuestra parte, incluyéndote a ti 🥹 Si CodePushGo cloud no satisface tus necesidades, puedes respaldar a un creador independiente [aquí](https://github.com/sponsors/riderx/) en tus propios términos
