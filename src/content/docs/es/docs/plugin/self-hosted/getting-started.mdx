...
Si CodePushGo no te conviene, entonces paga tu propio precio y [apoya a un Creador independiente](https://github.com/sponsors/riderx) en tus términos
...
| Características          | CodePushGo | Auto alojado |
| ------------------------ | ----- | ------------ |
| Actualizaciones         | ✅     | 🚧          |
| Auto reversión          | ✅     | 🚧          |
| Alertas por email       | ✅     | 🚧          |
...
> Ten en cuenta que no puedes usar la nube CodePushGo y tu servidor al mismo tiempo
...
La mejor manera de asegurarte de que tu zip es correcto es usar el CLI de CodePushGo para comprimir
...
:::note
Si esto parece mucho trabajo, prueba la versión de prueba de CodePushGo Cloud
:::
