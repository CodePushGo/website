---
title: Comandi
description: CodePushGo CLIドキュメント
sidebar:
  order: 2
locale: ja
---
...
* `--icon [/path/to/my/icon]` CodePushGoウェブアプリに表示するカスタムアイコン
...
* `--external <url>` CodePushGoクラウドにアップロードする代わりに外部URLにリンク
...
> 👀 CodePushGoクラウドは、リンク内（外部オプションの場合）や保存されたコードの内容を一切確認しません
