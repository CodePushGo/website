...
La commande `app` vous permet de gérer vos applications CodePushGo

### add

`npx @capgo/cli app add [appId]`

Ajoute une nouvelle application à votre compte CodePushGo
...
- `--icon [path]` : Chemin vers une icône personnalisée à afficher dans l'application web CodePushGo
...
Met à jour une application existante dans votre compte CodePushGo
...
Liste toutes les applications de votre compte CodePushGo
...
Supprime une application de votre compte CodePushGo
