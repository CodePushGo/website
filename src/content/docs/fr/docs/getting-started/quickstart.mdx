...
Le tutoriel de démarrage rapide vous guidera à travers les concepts clés de CodePushGo ! Les concepts qui seront explorés incluent :

<Steps>

1. Ajouter une application à votre compte CodePushGo

2. Intégrer CodePushGo à votre CI/CD

3. Déclencher le téléchargement des bundles sur CodePushGo en poussant des commits

4. Configurer et personnaliser la publication des bundles CodePushGo

5. Configurer votre application pour activer les mises à jour en direct via CodePushGo

6. Déployer des mises à jour en direct sur votre application depuis CodePushGo
...
<CardGrid stagger>
  <a href="/docs/getting-started/add-an-app/" ><Card title="Commencer le tutoriel" icon="rocket" >
    Suivez le tutoriel de démarrage rapide et lancez-vous avec CodePushGo en un rien de temps !
  </Card></a>
  <a href="/docs/getting-started/deploy/"><Card title="Facile à intégrer" icon="pencil">
    Intégrez CodePushGo à votre CI/CD et déclenchez des téléchargements de bundles sur CodePushGo en poussant des commits
  </Card></a>
...
<LinkCard
	title="Essayez GPTS CodePushGo pour obtenir de l'aide au lieu de lire la documentation"
...
Pour rendre cela possible, il est nécessaire que nous fassions tous notre part, y compris vous 🥹 Si CodePushGo cloud ne répond pas à vos besoins, vous pouvez soutenir un créateur bootstrappé [ici](https://github.com/sponsors/riderx/) selon vos conditions
