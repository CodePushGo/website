...
Si CodePushGo ne vous convient pas, alors fixez votre propre prix et [soutenez un créateur indépendant](https://github.com/sponsors/riderx) selon vos conditions
...
> Gardez à l'esprit que vous ne pouvez pas utiliser le cloud CodePushGo et votre serveur en même temps
...
:::note
Si cela semble beaucoup de travail, essayez l'essai gratuit de CodePushGo Cloud
:::
