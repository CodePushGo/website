...
Chaque fois que vous téléchargez un nouveau build et l'attribuez à un canal, CodePushGo conserve un historique de ces builds. Si vous devez annuler une mise à jour spécifique, vous pouvez sélectionner l'un de ces builds précédents pour le redéployer sur le canal.

Pour revenir à un build précédent :

<Steps>

1. Connectez-vous au [Tableau de bord CodePushGo](https://app.capgo.io)
...
1. Accédez au canal dans le Tableau de bord CodePushGo
