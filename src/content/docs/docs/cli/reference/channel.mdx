---
title: 📢 channel
description: 📢 Manage distribution channels for app updates in CodePushGo Cloud, controlling how updates are delivered to devices.
sidebar_label: channel
sidebar:
  order: 6
---

📢 Manage distribution channels for app updates in CodePushGo Cloud, controlling how updates are delivered to devices.
...
➕ Create a new channel for app distribution in CodePushGo Cloud to manage update delivery.
...
🗑️ Delete a channel from CodePushGo Cloud, optionally removing associated bundles to free up resources.
...
📋 List all channels configured for an app in CodePushGo Cloud to review distribution settings.
...
📦 Get the current bundle linked to a specific channel in CodePushGo Cloud for update tracking.
