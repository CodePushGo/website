...
- `-e, --external <url>`: Link to an external URL instead of uploading to CodePushGo Cloud
...
- `--partial`: Upload only changed files to CodePushGo Cloud
- `--partial-only`: Upload only partial files to CodePushGo Cloud, skipping the zipped file (useful for large bundles)
...
`npx @codepushgo/cli bundle compatibility [appId]`
...
`npx @codepushgo/cli bundle delete [bundleId] [appId]`
...
`npx @codepushgo/cli bundle cleanup [appId]`
...
`npx @codepushgo/cli bundle decrypt [zipPath] [sessionKey]`
...
`npx @codepushgo/cli bundle encrypt [zipPath]`
...
`npx @codepushgo/cli bundle encrypt [zipPath] [checksum]`
...
`npx @codepushgo/cli bundle decryptV2 [zipPath] [checksum]`
