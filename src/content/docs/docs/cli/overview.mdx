...
1. Complete the [CodePushGo Quickstart](/docs/getting-started/quickstart) to set up your app in CodePushGo and install the CodePushGo SDK.
...
- The CodePushGo CLI doesn't require a separate installation step. It's bundled with the `@codepushgo/cli` package and can be run directly using `npx`.
