...
description: This comprehensive guide provides detailed instructions on how to successfully transition your application from the Ionic AppFlow platform to the CodePushGo system, ensuring a smooth and efficient migration process.
sidebar:
  order: 7
---
...
1. [Register for a CodePushGo account](https://capgo.app/register/)
