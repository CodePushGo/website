---
title: "Settings"
description: "How to change the user settings, manage your info, name and email change your picture and more from your CodePushGo account"
sidebar:
  order: 4
---
...
First click on **FIRS_NAME SECOND_NAME**. In my case this is **test CodePushGo**. In your case, this will be your first name and then your second name. Then click on **Settings**.
