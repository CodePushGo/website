...
CodePushGo has an official [discord server](https://discord.com/invite/VnYRvBfgA6). Getting tech support there is likely one of the fastest ways to get a response.
...
This will allow the codepushgo staff to take a look at your account. Sharing this id is safe, as it was designed to be shared publicly.

To share this, please go to [codepushgo's settings](https://web.codepushgo.com/dashboard/settings/account/). There please click on `copy account id`.
