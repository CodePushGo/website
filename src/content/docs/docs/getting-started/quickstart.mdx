...
The quickstart tutorial will walk you through the key concepts of CodePushGo! Concepts that will be explored include:

<Steps>

1. Adding an app to your CodePushGo account

2. Integrating CodePushGo with your CI/CD

3. Triggering bundle upload on CodePushGo by pushing commits 

4. Configuring and customizing the CodePushGo bundle publishing

5. Setting up your app to enable live updates via CodePushGo

6. Deploying live updates to your app from CodePushGo
...
<CardGrid stagger>
  <a href="/docs/getting-started/add-an-app/" ><Card title="Start the Tutorial" icon="rocket" >
    Follow the quickstart tutorial and get up and running with CodePushGo in no time!
  </Card></a>
  <a href="/docs/getting-started/deploy/"><Card title="Ship updates" icon="pencil">
    Ship updates to your app from the CodePushGo dashboard.
  </Card></a>
  <a href="/docs/getting-started/cicd-integration/"><Card title="Automate updates" icon="pencil">
    Integrate CodePushGo with your CI/CD and trigger bundle uploads on CodePushGo by pushing commits.
  </Card></a>
...
If you make any changes to the native code, such as updates to React Native plugins, it is mandatory to resubmit the application to the app store for approval.
</Aside>

## Join Discord Community

[Join the React Native-updater Discord Server!](https://discord.com/invite/VnYRvBfgA6)

## Maintenance

| Plugin version | React Native compatibility | Maintained        |
| -------------- | ----------------------- | ----------------- |
| v7.\*.\*       | v7.\*.\*                | ✅                 |
...
Android Google Play and iOS App Store have corresponding guidelines that have rules you should be aware of before integrating the React Native-updater solution within your application.
...
That fully allows React Native-updater as it updates just the JS bundles and won't update native code.
...
React Native-updater allows you to follow these rules in full compliance so long as the update you push does not significantly deviate your product from its original App Store approved intent.
...
<LinkCard
	title="Try GPTS CodePushGo to Get help instead of reading  the docs"
	href="https://chat.openai.com/g/g-3dMwHbF2w-codepushgo-doc-gpt"
/>
...
To make this possible, it's necessary for all of us to do our part, including you 🥹. If CodePushGo cloud doesn't meet your needs, you can back a bootstrapped Maker [here](https://github.com/sponsors/riderx/) on your own terms.
