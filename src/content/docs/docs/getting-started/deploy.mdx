...
description: "Learn how to deploy a live update to your app using CodePushGo's Live Updates feature, enabling real-time UI and logic updates without app store resubmission."
sidebar:
  order: 3
---
