...
If codepushgo offers can't suit you, then put your price and back a bootstrapped Maker [HERE](https://github.com/sponsors/riderx/) on your terms.
...
```bash
npx @codepushgo/cli bundle zip --path [/path/to/my/bundle]
```
...
You can use this feature by creating a private key ``npx @codepushgo/cli key create``

Then you encrypt your zip file with ``npx @codepushgo/cli encrypt [path/to/zip]``
...
<LinkCard
	...
	href="https://codepushgo.com/blog/self-hosted-live-updates/"
/>
