---
title: "Using the capacitor updater with self-hosted codepushgo"
description: "How to use the capacitor updater with self-hosted codepushgo"
sidebar:
    order: 2
---
...
This tutorial will show how to use capacitor updater in a dev environment with self hosted codepushgo
