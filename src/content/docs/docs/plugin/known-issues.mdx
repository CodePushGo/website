---
title: "Known issues"
description: "Known issues with React Native and CapGo"
sidebar:
  order: 7
---
...
If you zipped your bundle with something different than the CLI, the format or your zip could be incorrect, please use the CLI command `npx @codepushgo/cli zip BUNDLE_FOLDER`.
