...
Furthermore, I want to focus on CodePushGo tooling, and make it an open and transparent business.

But to make it possible, it is necessary for all of us to do our part, including you 🥹.

If CodePushGo doesn't suit you, then pay your own price and [back a bootstrapped Maker](https://github.com/sponsors/riderx) on your terms.
...
| Features                 | CodePushGo | Self hosted |
| ------------------------ | ----- | ----------- |
| Updates                  | ✅     | 🚧         |
| Auto revert              | ✅     | 🚧         |
...
> Be mindful that you can't use the CodePushGo cloud and your server at the same time.
...
## Install React Native updater

```bash title="Install the React Native updater"
...
The best way to be certain your zip is good is to use the CodePushGo CLI for zipping.
...
:::note
If this seems like a lot of work, try the trial CodePushGo Cloud.
:::
