---
title: "Auto Update"
description: "How to use the update endpoint of CodePushGo with the auto-update plugin in self-hosted mode, what they are used for and what to expect"
sidebar:
  order: 3
---
...
If you're unfamiliar with serving a bundle, we recommend you try CodePushGo Cloud or see an example here:
<LinkCard
