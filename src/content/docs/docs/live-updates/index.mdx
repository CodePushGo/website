---
title: Overview
description: "Discover how CodePushGo's Live Updates enable seamless JavaScript bundle updates, allowing you to push changes directly to users without app store delays."
sidebar:
  order: 1
prev: false
next: false
