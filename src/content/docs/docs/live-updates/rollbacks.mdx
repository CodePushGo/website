...
CodePushGo provides several ways to manage a channel's builds and control the version of your app that users receive.
...
1. Log in to the [CodePushGo Dashboard](https://app.codepushgo.io).
