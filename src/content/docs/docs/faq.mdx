...
### Can I use CodePushGo with my team?[](https://capgo.app/docs/faq/#can-i-use-capgo-with-my-team "Direct link to Can I use CodePushGo with my team?")
...
### Does CodePushGo store my source code?[](https://capgo.app/docs/faq/#does-capgo-store-my-source-code "Direct link to Does CodePushGo store my source code?")

No. CodePushGo servers never see your source code. When you run `npx @capgo/cli app update` the `npx @capgo/cli` tool only uploads the same compiled code that you send to the app stores. If you desire additional security, you can use End to End encryption to encrypt your bundle before uploading it to CodePushGo servers.

See also our privacy policy: [https://capgo.app/privacy](https://capgo.app/privacy/)

### Can I use CodePushGo from my CI system?[](https://capgo.app/docs/faq/#can-i-use-capgo-from-my-ci-system "Direct link to Can I use CodePushGo from my CI system?")
...
Yes. There is no limit on the size of the application that can be updated with code push. As noted [below](https://capgo.app/docs/faq/#what-types-of-changes-does-capgo-code-push-support), CodePushGo can change any JS code in your application no matter of size.

To note: A bigger size make it harder for users to download updates. We recommend keeping your app as small as possible.

### What can I use CodePushGo code push for?[](https://capgo.app/docs/faq/#what-can-i-use-capgo-code-push-for "Direct link to What can I use CodePushGo code push for?")
...
### What counts as a "MAU" for CodePushGo?[](https://capgo.app/docs/faq/#what-counts-as-a-mau-for-capgo "Direct link to What counts as a \"MAU\" for CodePushGo?")
...
### What can't we use CodePushGo code push for?[](https://capgo.app/docs/faq/#what-cant-we-use-capgo-code-push-for "Direct link to What can't we use CodePushGo code push for?")

As above, CodePushGo should not be used to violate app store polices. Please see [below](https://capgo.app/docs/faq/#does-capgo-comply-with-play-store-guidelines) for more information.
...
### Does CodePushGo submit to the stores for me?[](https://capgo.app/docs/faq/#does-capgo-submit-to-the-stores-for-me "Direct link to Does CodePushGo submit to the stores for me?")
...
### What does CodePushGo store on disk and where?[](https://capgo.app/docs/faq/#what-does-capgo-store-on-disk-and-where "Direct link to What does CodePushGo store on disk and where?")

The CodePushGo updater (included in your application when you build your app) caches the latest downloaded bundle in the only directory that capacitor allow to load code. On Android, this is located in `/data/user/0/com.example.app/code_cache/capgo_updater` although the base of that path is provided by the Android system and can change dynamically at runtime. On iOS devices, data is stored under `Library/Application Support/capgo`.

The CodePushGo command line tools (e.g. `npx @capgo/cli app update`) are installed on disk in npm caches, your logins are stored in your home directory in `~/.capgo`.

### How does this relate to React Native Hot Reload?[](https://capgo.app/docs/faq/#how-does-this-relate-to-capacitor-hot-reload "Direct link to How does this relate to React Native Hot Reload?")
...
### What types of changes does CodePushGo code push support?[](https://capgo.app/docs/faq/#what-types-of-changes-does-capgo-code-push-support "Direct link to What types of changes does CodePushGo code push support?")
...
### What OS versions does CodePushGo support?[](https://capgo.app/docs/faq/#what-os-versions-does-capgo-support "Direct link to What OS versions does CodePushGo support?")
...
### What versions of React Native does CodePushGo support?[](https://capgo.app/docs/faq/#what-versions-of-flutter-does-capgo-support "Direct link to What versions of Flutter does CodePushGo support?")
...
### Does CodePushGo comply with Play Store guidelines?[](https://capgo.app/docs/faq/#does-capgo-comply-with-play-store-guidelines "Direct link to Does CodePushGo comply with Play Store guidelines?")
...
CodePushGo is designed to be compatible with the Play Store guidelines. However CodePushGo is a tool, and as with any tool, can be abused. Deliberately abusing CodePushGo to violate Play Store guidelines is in violation of the CodePushGo [Terms of Service](https://capgo.app/tos/) and can result in termination of your account.
...
### Does CodePushGo comply with App Store guidelines?[](https://capgo.app/docs/faq/#does-capgo-comply-with-app-store-guidelines "Direct link to Does CodePushGo comply with App Store guidelines?")
...
Deliberately abusing CodePushGo to violate App Store guidelines is in violation of the CodePushGo [Terms of Service](https://capgo.app/tos/) and can result in termination of your account.

Microsoft also publishes a guide on how their react native "codepush" library complies with the app stores: [https://github.com/microsoft/react-native-code-push#store-guideline-compliance](https://github.com/microsoft/react-native-code-push/#store-guideline-compliance)

### Can I use CodePushGo in my country?[](https://capgo.app/docs/faq/#can-i-use-capgo-in-my-country "Direct link to Can I use CodePushGo in my country?")
...
-   [https://api.capgo.app](https://api.capgo.app/) -- used by the `npx @capgo/cli` command line tools to interact with the CodePushGo servers as well as the CodePushGo updater on users' devices to check for updates.
...
### Can I self-host CodePushGo?[](https://capgo.app/docs/faq/#can-i-self-host-capgo "Direct link to Can I self-host CodePushGo?")

Yes, you can self-host CodePushGo. The guide is not yet written, but the code is open source and available at [https://github.com/cap-go/capgo](https://github.com/cap-go/capgo/)
...
### How is CodePushGo affected by lack of network connectivity?[](https://capgo.app/docs/faq/#how-is-capgo-affected-by-lack-of-network-connectivity "Direct link to How is CodePushGo affected by lack of network connectivity?")
...
CodePushGo command line tools (e.g. `npx @capgo/cli app update`) require network connectivity to function. If you are using CodePushGo to distribute your app, you should ensure that your CI system has network connectivity.
...
### How does CodePushGo relate to React Native?[](https://capgo.app/docs/faq/#how-does-capgo-relate-to-capacitor "Direct link to How does CodePushGo relate to React Native?")
...
It is also possible to run the CodePushGo updater manually using [package:capgo\_code\_push](https://pub.dev/packages/capgo_code_push/), through which it is possible to trigger updates at any time, including via a push notification.
...
### What information is sent to CodePushGo servers?[](https://capgo.app/docs/faq/#what-information-is-sent-to-capgo-servers "Direct link to What information is sent to CodePushGo servers?")
...
### What platforms does CodePushGo support?[](https://capgo.app/docs/faq/#what-platforms-does-capgo-support "Direct link to What platforms does CodePushGo support?")
...
### How does CodePushGo interact with Play Testing Tracks or Apple TestFlight?[](https://capgo.app/docs/faq/#how-does-capgo-interact-with-play-testing-tracks-or-apple-testflight "Direct link to How does CodePushGo interact with Play Testing Tracks or Apple TestFlight?")
