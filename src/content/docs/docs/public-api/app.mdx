...
Apps are the foundational entities in CodePushGo. Each app represents a unique React Native application that you can manage and update through the platform. The Apps API allows you to create, retrieve, update, and delete app configurations.

## Understanding Apps

An app in CodePushGo represents your React Native application and includes:
...
- Use the app ID in the URL path: `https://api.codepushgo.com/app/:app_id`
...
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/app/?org_id=046a36ac-e03c-4590-9257-bd6c9dba9ee8"

# Get specific app
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/app/com.demo.app"
```
...
`https://api.codepushgo.com/app/:app_id`
