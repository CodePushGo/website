...
<figure><img style="margin-left: auto; margin-right: auto" src="/codepushgo_apikeys_diagram.webp" alt="A diagram explaining how API key work" /><figcaption></figcaption></figure>
...
`https://api.codepushgo.com/apikey/`
...
```bash
curl -H "authorization: your-api-key" https://api.codepushgo.com/apikey/
```
...
`https://api.codepushgo.com/apikey/:id/`
...
```bash
curl -X DELETE -H "authorization: your-api-key" https://api.codepushgo.com/apikey/1/
```
