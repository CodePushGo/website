...
Channels are the core mechanism for managing app updates in CodePushGo. They allow you to control how and when your users receive updates, enabling features like A/B testing, staged rollouts, and platform-specific updates.
...
`https://api.codepushgo.com/channel/`
...
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/channel/?app_id=app_123"

# Get specific channel
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/channel/?app_id=app_123&channel=beta"

# Get next page
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/channel/?app_id=app_123&page=1"
```
