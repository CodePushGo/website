---
title: "Bundles"
description: "Detailed guide for managing CodePushGo Bundles, covering listing, deleting, versioning, and storage optimization for app update packages."
sidebar:
  order: 8
---

Bundles are the core update packages in CodePushGo. Each bundle contains the web assets (HTML, CSS, JS) that make up your app's content. The Bundles API allows you to manage these update packages, including listing and deleting them.
