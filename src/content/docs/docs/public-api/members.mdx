...
`https://api.codepushgo.com/organization/members/`
...
- The user must already have a CodePushGo account before they can be invited. If they don't have an account, they should first create one at https://web.codepushgo.com/register/
...
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/organization/members/?orgId=org_123"
```
