...
- The user must already have a CodePushGo account before they can be invited. If they don't have an account, they should first create one at https://capgo.app/register/
