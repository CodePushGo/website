...
Devices represent individual installations of your app that are managed by CodePushGo. The Devices API allows you to track and manage devices, including their versions, channels, and update status.
...
`https://api.codepushgo.com/device/`
...
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/device/?app_id=app_123"

# Get specific device
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/device/?app_id=app_123&device_id=device_456"

# Get next page
curl -H "authorization: your-api-key" \
  "https://api.codepushgo.com/device/?app_id=app_123&page=1"
```
