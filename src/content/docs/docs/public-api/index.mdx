---
title: "API Overview"
description: "CodePushGo cloud public API documentation"
sidebar:
  order: 1
---
...
This is the documentation of the public API of CodePushGo cloud. The API allows you to programmatically manage your CodePushGo resources, including organizations, devices, channels, and bundles. It's designed to be RESTful and uses standard HTTP methods.
...
Example:
```bash
curl -H "authorization: your-api-key" https://api.codepushgo.com/organization/
```

<LinkCard
	title="Get API key"
	description="Generate your API key in the CodePushGo dashboard"
	href="https://web.codepushgo.com/dashboard/apikeys/"
/>
...
<LinkCard
	title="API Keys"
	description="Generate, list, and revoke API keys for secure access to the CodePushGo API"
