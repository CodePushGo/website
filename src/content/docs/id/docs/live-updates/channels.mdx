...
1. Buka bagian "Channels" di dashboard CodePushGo
...
Untuk menerapkan live update, Anda perlu mengunggah build bundle JS baru dan menetapkannya ke channel. Anda dapat melakukan ini dalam satu langkah dengan CodePushGo CLI:
...
Anda juga dapat menetapkan build ke channel dari bagian "Bundles" di dashboard CodePushGo. Klik ikon menu di sebelah build dan pilih "Assign to Channel" untuk memilih channel untuk build tersebut.

## Versi Bundle dan Channel

Penting untuk dicatat bahwa bundle di CodePushGo bersifat global untuk aplikasi Anda, tidak spesifik untuk channel individual. Bundle yang sama dapat ditetapkan ke beberapa channel.
...
Untuk alur kerja yang lebih canggih, Anda dapat mengotomatisasi deployment live update Anda sebagai bagian dari pipeline CI/CD Anda. Dengan mengintegrasikan CodePushGo ke dalam proses build Anda, Anda dapat secara otomatis mengunggah bundle baru dan menetapkannya ke channel setiap kali Anda push ke branch tertentu atau membuat rilis baru.

Lihat dokumen [Integrasi CI/CD](/docs/getting-started/cicd-integration/) untuk mempelajari lebih lanjut tentang mengotomatisasi live update CodePushGo.
...
1. Instal SDK CodePushGo di aplikasi Anda
