...
Meskipun pembaruan langsung CodePushGo memungkinkan Anda untuk dengan cepat memberikan peningkatan dan perbaikan kepada pengguna, mungkin ada situasi di mana Anda perlu kembali ke versi sebelumnya dari aplikasi Anda. Mungkin pembaruan baru memunculkan masalah kritis yang tidak terduga, atau mungkin Anda ingin mengembalikan perubahan tertentu sambil mengerjakan perbaikan.
...
Setiap kali Anda mengunggah build baru dan menetapkannya ke channel, CodePushGo menyimpan riwayat build tersebut. Jika Anda perlu mengembalikan pembaruan tertentu, Anda dapat memilih salah satu build sebelumnya untuk dideploy ulang ke channel.
...
1. Navigasi ke channel di CodePushGo Dashboard
