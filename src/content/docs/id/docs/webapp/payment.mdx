...
description: Manajemen pembayaran di akun CodePushGo Anda.
sidebar:
  order: 10
locale: id
---
...
A: Ya, pembayaran sepenuhnya dikelola oleh stripe. CodePushGo tidak pernah mendapatkan akses ke detail kartu kredit Anda. Stripe sangat serius menangani keamanan. [Pelajari lebih lanjut tentang kebijakan keamanan stripe](https://stripecom/docs/security/)
