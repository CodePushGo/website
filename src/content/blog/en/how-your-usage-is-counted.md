...
title: How your usage is counted in CodePushGo
description: >-
  Understand how CodePushGo count your usage, and use it at best. Learn to manage
  better your plan
...
head_image_alt: CodePushGo usage system explained
...
In CodePushGo, 3 values are counted and important to understand
- User's
- Storage
- Bandwidth
...
`npx @codepushgo/cli@latest bundle list`
...
`npx @codepushgo/cli@latest bundle cleanup`
...
In the future, CodePushGo will improve the download system to have more chances to download the bundle at one time.
